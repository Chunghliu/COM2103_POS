...
public class AddItem extends javax.swing.JDialog {
    ...
    public AddItem(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        LoadTable();
        txt_ID.setText(randomUUID(10, 0, 'C'));
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(" Clothes"));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "ID must be provided");
            return;
        }
        ...
        try{
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Details saved succesfully", "System Notification", JOptionPane.INFORMATION_MESSAGE);
            LoadTable();
        }catch(Exception e)
        {
            e.printStackTrace();
