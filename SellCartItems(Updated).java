...
public class SellCartItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        amountPaid.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                amountPaidKeyTyped(evt);
            }
        });

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Select Mode of Payment--", "Cash", "Debit/ Credit Card", " " }));
        ...
        txt_amtPay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_amtPayActionPerformed(evt);
            }
        });

        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/attatchments/Receive Cash_24px.png"))); // NOI18N
        jButton6.setText("STAFF DISCOUNT");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {amountPaid, jComboBox1, txt_amtPay, txt_bonus});
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Staff Discount"));
        ...
        txt_staffName.setEditable(false);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_staffName, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txt_staffID, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txt_staffID, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_staffName, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel10))
    ...
    private void txt_clotheIdKeyTyped(java.awt.event.KeyEvent evt) {                                      
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        int amtttt = Integer.parseInt(amountPaid.getText());
        ...
        try
        {
            ...
            //record payment
            RecordPayment(ReceiptNumber,  amountPaid.getText(), (String) jComboBox1.getSelectedItem());
    ...
    private void amountPaidKeyTyped(java.awt.event.KeyEvent evt) {                                    
        char c = evt.getKeyChar();
        if(!(Character.isDigit(c)|| c==java.awt.event.KeyEvent.VK_BACK_SPACE)|| c==java.awt.event.KeyEvent.VK_DELETE){
            evt.consume();
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       ...
       if(txt_staffID.getText().isEmpty()){
            ...
            try{
                ...
                conn = Connect.Connectdb();
                stm = conn.createStatement();
                String quotaAvailable = "select QuotaAvailable from staff_discount_quota where Id =" + txt_staffID.getText();
                rs = stm.executeQuery(quotaAvailable);

                while(rs.next()){
                    remains = rs.getInt("QuotaAvailable"); //取得quota剩餘值
            ...
            double finalAmt = Double.parseDouble(txt_amtPay.getText()); //取得結帳總數(未計discount)
            if(remains <= quota){
                afterDiscount = finalAmt * 0.4; //結帳總數 * 0.4
                txt_amtPay.setText(Double.toString(afterDiscount));
                quotaUsed = finalAmt - afterDiscount; //coumpute quota used
                txt_bonus.setText(Double.toString(quotaUsed));
                remains = remains - quotaUsed; // compute quota remains
                quotaAvailable(quotaUsed,remains, txt_staffID.getText());
            }
            else{
                JOptionPane.showMessageDialog(null,txt_staffID.getText()+" has used all the discount quotas today");
            }
        }
        resetQuota();
        resetInfo();
    }                                        
    public void quotaAvailable(double quotaUsed, double quotaRemains, String staffID){
        try{
            //double quotaUsedAmt = 0;
            //quotaUsedAmt += quotaUsed; //Update用左幾多quota(總數)
            DatabaseConnection.DbConnection Connect = new DatabaseConnection.DbConnection();
            conn = Connect.Connectdb();
            String record = "UPDATE staff_discount_quota set QuotaUsed=?, QuotaAvailable=? where Id=?";
            pst = conn.prepareStatement(record);
            pst.setDouble(1, quotaUsed);
            pst.setDouble(2, quotaRemains);
            pst.setString(3, staffID);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,txt_staffName.getText() + " has " + quotaRemains + " available\nPlease confirm payment");
            
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,e.getMessage());
        }
    }
    private void txt_staffIDKeyReleased(java.awt.event.KeyEvent evt) {                                        
        try{
            DatabaseConnection.DbConnection Connect = new DatabaseConnection.DbConnection();
            conn = Connect.Connectdb();
            String sql = "select name from profilemaster where id=?";
            pst = conn.prepareStatement(sql);
            pst.setString(1,txt_staffID.getText());
            rs = pst.executeQuery();
            while(rs.next()){
                txt_staffName.setText(rs.getString("name"));
            }
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void resetQuota(){
        ...
        if(currentHour == 00 & currentMin == 00){
            try{
                DatabaseConnection.DbConnection Connect = new DatabaseConnection.DbConnection();
                conn = Connect.Connectdb();
                String sql = "Update staff_discount_quota SET QuotaUsed = 0, QuotaAvailable = 200"; //每當00:00, reset所有員工QuotaUsed, QuotaAvailable
                pst = conn.prepareStatement(sql);
                pst.execute();
    ...
    private void txt_staffIDKeyTyped(java.awt.event.KeyEvent evt) {                                     
        
    }                                    

    private void txt_staffNameKeyReleased(java.awt.event.KeyEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void txt_staffNameKeyTyped(java.awt.event.KeyEvent evt) {                                       
        // TODO add your handling code here:
    }                                      

    private void txt_staffNameActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
    }                                             

    private void amountPaidActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void txt_amtPayActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          
